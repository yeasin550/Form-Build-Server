...
const uri =
  `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.3iohovs.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    console.log("Pinged your deployment. You successfully connected Yeasin to MongoDB!");
  } finally {
